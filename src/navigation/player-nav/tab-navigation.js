...
const getPathData = (iconName) => {
  switch (iconName) {
    case 'home-sharp':
      return 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z'; // Example path data
  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarActiveTintColor: 'black', // You might want to adjust this based on your design
        headerShown: false,
      })}
    >
      <Tab.Screen name="PlayerChatHome" component={PlayerChatHome} />
      <Tab.Screen name="PlayerChatSystemChat" component={PlayerChatSystemChat} />
