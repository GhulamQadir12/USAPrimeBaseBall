...
import DirectorChatHome from '../../screens/director-chat-system-home/index';
import DirectorSwitchChat from '../../screens/director-switch-chat/index';
...
const MyTabs = () => {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        tabBarIcon: ({ size, focused }) => {
          ...
          switch (route.name) {
            case 'DirectorChatHome':
              iconName = 'home-sharp';
              break;
            case 'DirectorSwitchChat':
    ...
    >
      <Tab.Screen name="DirectorChatHome" component={DirectorChatHome} />
      <Tab.Screen name="DirectorSwitchChat" component={DirectorSwitchChat} />
