...
//         </View>
//         <Text style={styles.profileName}>Christiano Ronaldo</Text>
//       </LinearGradient>
...
//           />
//            <Touchable
//           onPress={()=>{navigation.navigate('PlayerRequest')}}
//             leftImage={IMG.ball}
...
const CustomDrawerContent = props => {
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <Touchable
      onPress={()=>{navigation.navigate('CoachLive')}}
            leftImage={IMG.Term}
            title={'Live Streams'}
            buttonstyle={styles.logoutButton2}
            textStyle={styles.logoutText}
